...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_2066dd0d73f9274794bb23a9304d64e8a9').trim(),
  DATABASE:
  ...
  PREFIX: (process.env.PREFIX || 'X').trim(),
  SUDO: process.env.SUDO || '',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME,
  HEROKU_API_KEY: process.env.HEROKU_API_KEY,
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️,NEMESIX',
